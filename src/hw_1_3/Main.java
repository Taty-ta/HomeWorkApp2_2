...
// или
        for (String x : fruits) {
            map.put(x, map.getOrDefault(x, 0) + 1); // если такой ключ есть, верни если нет выведи 0. к тому что вернешь добавь 1
        ...
        phBook.add("Petrov", "22-77-555");
        phBook.add("Ivanov", "22-78-555");
        phBook.add("Sidorov", "22-79-555");
        phBook.add("Petrov", "22-77-777");
        System.out.println("Тел: " + phBook.get("Petrov"));// находим по ключу и возвращаем все номера
        System.out.println("Тел: " + phBook.get("Ivanov"));
    }
